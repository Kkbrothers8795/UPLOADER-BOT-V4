...
"""
    ABOUT_TEXT = """
**Mʏ ɴᴀᴍᴇ** : [ᴜʀʟ-ᴜᴘʟᴏᴀᴅʙᴏᴛ ᴠ4](https://t.me/Hx_URLuploadBot)

**Cʜᴀɴɴᴇʟ** : [ʜx Bᴏᴛs](https://t.me/HxSourceCode)

**Sᴏᴜʀᴄᴇ** : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://github.com/oVo-HxBots)

**Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ** : [ʜx Sᴜᴘᴘᴏʀᴛ](https://t.me/HxSupport)
...
"""
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/kirodewal'>@kirodewal</a>"
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/kirodewal'>@Kirodewal</a>"
